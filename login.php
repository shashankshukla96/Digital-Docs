...
<body class="blue-gradient">
  ...
  <form action="changes.php" method="POST" id="form" enctype="multipart/form-data">
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-lg-12 col-sm-12">
          ...
          <div class="card card-sm testimonial-card">
            ...
            <div class="avatar mx-auto white">
              ...
              <button type="button" class="todisable btn white" id="bbttnn">
                <img src=<?php echo "img/".$email."/image.png";?> id="profile" alt="Profile Pic">
              </button>
            </div>
            <div class="card-body">
            
            <h4 class="card-title">Your enetered details.</h4>
              <hr>
              <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12">
                  <div class="md-form form-sm">
                    <input type="text" id="Form-pass1-name" readonly required="required" class="text-field form-control form-control-sm" name="name" value="abcd">
                    <label for="Form-pass1-name">Name</label>
                  </div>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12">
                  <div class="md-form form-sm">
                    <input readonly type="number" id="Form-pass1-age" required="required" class="text-field form-control form-control-sm" name="age" value="123">
                    <label for="Form-pass1-age">Age</label>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12">
                  <div class="md-form form-sm">
                    <input type="email" readonly id="Form-pass1-email" required="required" class="form-control form-control-sm" name="email" value="abcd">
                    <label for="Form-pass1-email">E-mail</label>
                  </div>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12">
                  <div class="md-form form-sm">
                    <input readonly type="number" id="Form-pass1-mobile" name="mobile" required="required" class="text-field form-control form-control-sm" value="123">
                    <label for="Form-pass1-mobile">Mobile</label>
                  </div>
                </div>
              </div>
              <!-- ROW 3 -->
              <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12 tohide ">
                  <div class="md-form form-sm">
                    <input type="password" id="Form-pass1-pass" required="required" class="form-control form-control-sm" name="pass" value="password">
                    <label for="Form-pass1-pass">Password</label>
                  </div>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12 tohide ">
                  <div class="md-form form-sm">
                    <input type="password" id="Form-pass1-pass-confirm" required="required" name="pass-confirm" class="form-control form-control-sm" value="password">
                    <label for="Form-pass1-pass-confirm">Confirm password</label>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12">
                  <div class="md-form form-sm">
                    <input type="text" readonly id="Form-pass1-father" required="required" class="text-field form-control form-control-sm" name="father" value="a12">
                    <label for="Form-pass1">Father's name</label>
                  </div>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12">
                  <div class="md-form form-sm">
                    <input type="text" readonly id="Form-pass1-mother" name="mother" required="required" class="form-control form-control-sm text-field" value="123">
              ...
              <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12">
                  <div class="md-form form-sm">
                    <input type="text" id="Form-pass1-date" name="date" required="required" class="text-field datepicker form-control form-control-sm" readonly value="01/02/2018">
            ...
            <div class="row">
              <div class="col-lg-12 col-md-13 col-sm-12 col-xs-12">
                <div class="md-form form-sm">
                  <input type="text" id="Form-pass1-address" name="address" required="required" class="text-field form-control form-control-sm" readonly value="01/02/2018" >
            ...
            <div class="row">
              <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class="md-form form-sm">
                  <input type="text" id="Form-pass1-city" readonly value="123" name="city" required="required" class="form-control text-field form-control-sm">
                  <label for="Form-pass1-city">City</label>
                </div>
              </div>
              <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class="md-form form-sm">
                  <input type="text" id="Form-pass1-state" name="state" readonly value="01/02/2018" required="required" class="form-control text-field form-control-sm">
                  <label for="Form-pass1">State</label>
                </div>
              </div>
              <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class="md-form form-sm">
                  <input type="text" id="Form-pass1-pin" name="pin" required="required" readonly value="01/02/2018" class="form-control text-field form-control-sm">
            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-4 col-sm-8 col-xs-8">
                <select class="browser-default custom-select todisable" id="qual-select" name="qual">
                  <option selected value="No education">No education</option>
              ...
              <div class="col-lg-4 col-md-4 col-sm-8 col-xs-8" >
                <div class="custom-control custom-radio custom-control-inline">
                  <input type="radio" class="custom-control-input todisable" value="Public" id="public" name="work">
                  <label class="custom-control-label" for="public">Public Sector</label>
                </div>
                <!-- Default inline 2-->
                <div class="custom-control custom-radio custom-control-inline">
                  <input type="radio" class="custom-control-input todisable" id="private" value="Private" name="work">
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="md-form form-sm">
                  <input type="text" readonly value="01/02/2018" id="Form-pass1-dept" name="dept" required="required" class="form-control text-field form-control-sm">
                  <label for="Form-pass1-dept">Department of work</label>
                </div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="md-form form-sm">
                  <input type="text" id="Form-pass1-title" readonly value="01/02/2018" name="title" required="required" class="form-control text-field form-control-sm">
            ...
            <div class="row">
              <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
                ...
                <div class="dropdown">
                  ...
                  <button type="button" style="width: 100%;" class="todisable btn btn-primary btn-md dropdown-toggle" id="thumbDropdown" data-toggle="dropdown" aria-haspopup="true" value="123" aria-expanded="false">Thumb</button>
                  <input type="text" hidden id="thumb-text" name="thumb-type" value="123">  


                  <!--Menu-->
                  <div class="dropdown-menu dropdown-primary">
                    <button type="button" class="dropdown-item thumb-drop" value="Left">Left Thumb</button>
                    <button type="button" class="dropdown-item thumb-drop" value="Right">Right Thumb</button>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-3 col-lg-3 col-sm-6 col-xs-6">
                <div class="md-form form-sm">
                  ...
                  <label for="thumb-file-trigger">Thumb Impression</label>
                  <input type="file" name="thumb" id="thumb-file-input" hidden="hidden">
                </div>
              </div>

              <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
                <button type="button" class="todisable btn btn-md btn-primary" id="pan-btn" style="width: 100%;">Browse</button>
              </div>

	            <div class="col-lg-1 col-md-1 col-sm-2 col-xs-2">
	            	<button type="button" class="btn btn-md btn-primary view-btn" id="pan-view-btn" value="pan">View</button>
	            </div>

              <div class="col-md-3 col-lg-3 col-sm-6 col-xs-6">
                <div class="md-form form-sm">
                  <input type="text" id="pan-file-trigger" value="Pan Card File" name="pan-file" required="required" readonly class="form-control form-control-sm">
                  <label for="pan-file-trigger">Pan Card</label>
            ...
            <div class="row">
              <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
                <button type="button" class="todisable btn btn-md btn-primary" id="adhar-btn" style="width: 100%;">Browse</button>
              </div>
				<div class="col-lg-1 col-md-1 col-sm-2 col-xs-2">
	            	<button type="button" class="btn btn-md btn-primary  view-btn" id="adhar-view-btn" value="adhar">View</button>
	            </div>
              ...
              <div class="col-md-3 col-lg-3 col-sm-6 col-xs-6">
                <div class="md-form form-sm">
                  ...
                  <label for="adhar-file-trigger">Adhar Card</label>
                  <input type="file" name="adhar" id="adhar-file-input" hidden="hidden">
                </div>
              </div>

              <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
                <button type="button" class="todisable btn btn-md btn-primary" id="dl-btn" style="width: 100%;">Browse</button>
              </div>

				<div class="col-lg-1 col-md-1 col-sm-2 col-xs-2">
	            	<button type="button" class="btn btn-md btn-primary view-btn" id="dl-view-btn" value="dl">View</button>
	            </div>
              ...
              <div class="col-md-3 col-lg-3 col-sm-6 col-xs-6">
                <div class="md-form form-sm">
                  ...
                  <label for="dl-file-trigger">Driver's Licence</label>
            ...
            <div class="row">
              <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
                <button type="button" class="todisable btn btn-md btn-primary" id="passport-btn" style="width: 100%;">Browse</button>
              </div>
				<div class="col-lg-1 col-md-1 col-sm-2 col-xs-2">
	            	<button type="button" class="btn btn-md btn-primary view-btn" id="passport-view-btn" value="passport">View</button>
	            </div>
              ...
              <div class="col-md-3 col-lg-3 col-sm-6 col-xs-6">
                <div class="md-form form-sm">
                  ...
                  <label for="passport-file-trigger">Passport front page</label>
                  <input type="file" name="passport" id="passport-file-input" hidden="hidden">
                </div>
              </div>

              <div class="col-lg-2 col-md-2 col-sm-4 col-xs-4">
                <button type="button" class="todisable btn btn-md btn-primary" id="bank-btn" style="width: 100%;">Browse</button>
              </div>
				<div class="col-lg-1 col-md-1 col-sm-2 col-xs-2">
	            	<button type="button" class="btn btn-md btn-primary view-btn" value="bank" id="bank-view-btn">View</button>
	            </div>
              ...
              <div class="col-md-3 col-lg-3 col-sm-6 col-xs-6">
                <div class="md-form form-sm">
                  ...
                  <label for="bank-file-trigger">Bank Passbook</label>
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="md-form form-sm">
                  <input type="text" id="Form-pass1-bank-name" name="bank-name" readonly value="01/02/2018" required="required" class="form-control text-field form-control-sm">
                  <label for="Form-pass1-bank-name">Name of the Bank</label>
                </div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="md-form form-sm">
                  <input type="text" id="Form-pass1-bank-branch" name="bank-branch" required="required" readonly value="01/02/2018" class="form-control text-field form-control-sm">
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="md-form form-sm">
                  <input type="text" id="Form-pass1-account" name="account" required="required" readonly value="01/02/2018" class="form-control text-field form-control-sm">
                  <label for="Form-pass1-account">Account Number</label>
                </div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="md-form form-sm">
                  <input type="text" id="Form-pass1-code" name="bank-code" required="required" readonly value="01/02/2018" class="form-control text-field form-control-sm">
            ...
            <div class="row">
              ...
              <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                ...
                <div hidden class="custom-control custom-checkbox tohide">
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                          ...
                          <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  <p class="text-info">
                                  	<b>1. I accept that all the information provided above is correct.<br>
             ...
             <!-- ROW Last -->
              ...
              <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                  <button type="button" id="edit-btn" class="btn btn-success" value="Submit" style="width: 100%;">Edit</button>
                </div>
                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12"></div>
                <div class="col-lg-1 col-md-1 col-sm-12 col-xs-12"></div>
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                	<button type="Submit" name="submit-btn" id="sub-btn" disabled class="btn blue-gradient btn-block btn-primary" value="Submit" style="width: 100%;">Save Changes</button>
                </div>
                <div class="col-lg-1 col-md-1 col-sm-12 col-xs-12"></div>
              </div>
...
<footer class="page-footer font-small teal pt-4">
  ...
  <!-- Footer -->
  <!-- Footer -->
<footer class="page-footer font-small cyan darken-3" id="about">
   ...
   <!-- JQuery -->
    ...
    <script type="text/javascript">
      ...
      $("documet").ready(function(){
      	...
      	var email = $('#Form-pass1-email').val();
    	
    	var addr = "img/"+email+"/"+"thumb"+".png";
    	$("#thumb-view-modal #view-image").attr("src", addr);
    	
    	var addr = "img/"+email+"/"+"pan"+".png";
    	$("#pan-view-modal #view-image").attr("src", addr);
    	

    	var addr = "img/"+email+"/"+"adhar"+".png";
    	$("#adhar-view-modal #view-image").attr("src", addr);
    	
    	var addr = "img/"+email+"/"+"dl"+".png";
      	$("#dl-view-modal #view-image").attr("src", addr);
    	
    	var addr = "img/"+email+"/"+"passport"+".png";
    	$("#passport-view-modal #view-image").attr("src", addr);
    	
    	var addr = "img/"+email+"/"+"bank"+".png";
    	$("#bank-view-modal #view-image").attr("src", addr);
      ...
      $("#edit-btn").click(function(){
      	...
      	$(".text-field").removeAttr("readonly");
    ...
    // $(".view-btn").click(function(){
    // 	var email = $('#Form-pass1-email').val();
    // 	var addr = "img/"+email+"/"+this.value+".png";
    // 	$("#view-modal-title").text(this.value);
    // 	$("#view-image").attr("src", addr);
...
<?php
	...
	echo "   <script>
				$('#Form-pass1-name').val('".$row['Name']."');
				$('#Form-pass1-age').val('".$row['Age']."');
				$('#Form-pass1-email').val('".$row['Email']."');
				$('#Form-pass1-mobile').val('".$row['Mobile']."');
				$('#Form-pass1-pass').val('".$row['Password']."');
				$('#Form-pass1-pass-confirm').val('".$row['Password']."');
				$('#Form-pass1-father').val('".$row['Father']."');
				$('#Form-pass1-mother').val('".$row['Mother']."');
				$('#Form-pass1-date').val('".$row['Date']."');
				$('#Form-pass1-address').val('".$row['Address']."');
				$('#Form-pass1-city').val('".$row['City']."');
				$('#Form-pass1-state').val('".$row['State']."');
				$('#Form-pass1-pin').val('".$row['Pin']."');
				$('#Form-pass1-dept').val('".$row['Department']."');
				$('#Form-pass1-title').val('".$row['Title']."');
				$('#Form-pass1-bank-name').val('".$row['Bank-name']."');
				$('#Form-pass1-bank-branch').val('".$row['Bank-branch']."');
				$('#Form-pass1-account').val('".$row['Account']."');
				$('#Form-pass1-code').val('".$row['Bank-code']."');
				$('#thumbDropdown').text('".$row['Thumb']."');
				$('#qual-select').val('".$row['Qualification']."');
			</script>";

			if($row['Work'] === 'Private')
			{
				echo "<script>$('#private').click();</script>";
			}
			else
			{
				echo "<script>$('#public').click();</script>";	
			}
?>